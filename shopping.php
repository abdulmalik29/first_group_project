...
function displayItems($mysqli){
        ...
        while($row = $itemRecords1->fetch_assoc())
        {
            echo '<tr width="100%"><td align="left">' .
                ...
                $row['price'] . '</td>
                <td align="left"><form action="deleteRecord.php" method="POST"><input type="submit" style="background-color: #f44336; padding: 5px 5px 5px 5px;" value="X" name="del"></form></td>
                </tr>';
        }
        echo '</table></div><br>';
